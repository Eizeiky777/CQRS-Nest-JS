...
import { GetHeroesQuery, GetHeroesQuery2 } from './queries/impl';
...
export class HeroesGameController {
  ...
  @Get('test/query-handler')
  async findAll2(): Promise<Hero[]> {
    return this.queryBus.execute(new GetHeroesQuery2());
  }
}
